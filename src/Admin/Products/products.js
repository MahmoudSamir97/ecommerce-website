...
const manualProductsArr = [
  {
    ...
    price: 20.02,
    description:
      "Brushing only reaches 25% of your mouth, and the germs left behind after brushing double every 1-2 hours. Listerine",
    category: "Health",
  ...
  },
  {
    ...
    price: 5.02,
    description:
      "Haj Arafa Moroccan Clay has ability to draw out impurities and toxins from the skin . Moroccan clay is an eco-friendly and cruelty-free choice",
    category: "Health",
  ...
  },
  {
    ...
    price: 150.02,
    description:
      "Samsung Refrigerator RT40A3310SA/MR 396L - Metal Graphite The Digital Inverter Compressor automatically adjusts its speed in response to cooling requirements. The Power Cool feature releases intensely cold air into the refrigerator to cool your favorite food and drink.",
    category: "Appliances",
    image: "./images/1.jpg",
  },
  {
    ...
    productsContainer.innerHTML += `
        <div class="single-product" data-id="${product.id}">
            <div class="icons-container"> 
                <img src="../../../assets/images/dashboardimages/icons8-update-48.png" onclick="updateProduct(event)" alt="add icon" id="update-btn">
                <img src="../../../assets/images/dashboardimages/icons8-delete-64.png" onclick="deleteProduct(event)" alt="eye icon" id="delete-btn">
            </div>
